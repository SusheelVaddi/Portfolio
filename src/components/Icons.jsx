...
export function BrainIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9.5 2A5.5 5.5 0 0 0 4 7.5c0 1.3.5 2.6 1.4 3.5L12 18l6.6-7A5.5 5.5 0 0 0 12 2.5 5.5 5.5 0 0 0 9.5 2z"/>
...
export function SkillCategoryIcon({ icon }) {
  switch (icon) {
...
// Tool icon resolver — simplified SVG representations
export function ToolIcon({ icon }) {
  ...
  return <span style={{ fontSize: "1.2rem", fontWeight: 600 }}>{iconMap[icon] || "•"}</span>;
}

// Career goal icon resolver
export function GoalIcon({ icon }) {
  switch (icon) {
    case "scientist":
      return (
